"""
Django settings for ed_test_storyboard_72 project.
...
ROOT_URLCONF = 'ed_test_storyboard_72.urls'
...
WSGI_APPLICATION = 'ed_test_storyboard_72.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ed_test_storyboard_72 API",
    "DESCRIPTION": "API documentation for ed_test_storyboard_72 App",
    "VERSION": "v1",
}
