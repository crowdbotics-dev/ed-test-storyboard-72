...
## Project Structure
    ...
    ├── ed_test_storyboard_72  # Django project configurations
...
1. Clone this repo and `cd ed_test_storyboard_72`
...
2. Clone this repo and `cd ed_test_storyboard_72`
